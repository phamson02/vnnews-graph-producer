...
category_to_sources = {
    ArticleCategory.News: NEWS_SOURCES,
    ArticleCategory.Economy: ECONOMY_SOURCES,
    ArticleCategory.World: WORLD_NEWS_SOURCES,
    ArticleCategory.Entertainment: ENTERNTAINMENT_SOURCES,
}
